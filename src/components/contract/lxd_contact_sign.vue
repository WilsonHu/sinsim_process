    ...
    <div>
        ...
        <div>
            ...
            <el-col class="well well-lg" style="background-color: white; margin-top: 10px">
                            ...
                            <el-row>
                                ...
                                <el-col :span="4">
                                    ...
                                    <el-form-item label="类型:">
                                        ...
                                        <el-input v-model="filters.contractNum" placeholder="类型" auto-complete="off" clearable></el-input>
                                ...
                                <el-col :span="4">
                                    ...
                                    <el-form-item label="发起部门:">
                                        ...
                                        <el-input v-model="filters.applicantDepartment" placeholder="发起部门" auto-complete="off" clearable></el-input>
                                ...
                                <el-col :span="2" :offset="5">
                                    ...
                                    <el-button icon="el-icon-search" size="normal" style="float: right; margin-right: -12px" type="primary" @click="search">查询</el-button>
              ...
              <el-table-column align="center" min-width="125" prop="contactType" label="类型"></el-table-column>
...
<template scope="scope">
    <div>
        ...
        {{formatDate(scope.row.createDate)}}</div>
</template>
              </el-table-column>
...
<template scope="scope">
    <div>
        ...
        {{scope.row.updateDate != null ? formatDate(scope.row.updateDate) : "/"}}</div>
</template>
              </el-table-column>
