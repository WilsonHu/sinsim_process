                ...
                <el-col :span="24">
                    ...
                    <el-card class="box-card" style="margin: 25px" v-if="isFinanceVisible()">
                        ...
                        <el-row style="margin-top: 10px" v-show="isFinanceVisible()">
                            ...
                            <el-col :span="2" :offset="1" style="font-size: 28px;font-weight: bold; color: #F56C6C">
                                {{calculateTotalPrice()}}
                            </el-col>
                        </el-row>
                        <br/>
                                            ...
                                            <el-col :span="24" style="margin-top: 10px">
                                                <el-form-item label="附加装置：" :label-width="formLabelWidth"
                                                    ...
                                                    <div style="margin-top: 10px;margin-right: 10px">
                                                        <tinymce ref="editor" v-model="item.orderDetail.axleAddition"
                                                                 :readonly="changeOrderContentDisable(item.machineOrder)
...
//                }
            ...
            changeContractContentDisable(item) {
                return (
                    (item.status != CONTRACT_INITIAL && item.status != CONTRACT_REJECTED && item.status != CONTRACT_SPLITED && item.status != CONTRACT_CHANGED) ||
                    this.mode == this.SIGN_MODE
                );
            },
