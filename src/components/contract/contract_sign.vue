    ...
    <div>
        ...
        <div>
            ...
            <el-row>
                ...
                <el-col :span="2" :offset="2" v-if="userInfo.role.roleName.indexOf('销售') != -1 || userInfo.role.id == 1">
            ...
            <el-col class="well well-lg" style="background-color: white; margin-top: 10px">
                ...
                <el-row>
                    ...
                    <el-col>
                            ...
                            <el-row>
                                ...
                                <el-col :span="4">
                                    ...
                                    <el-form-item label="合同号:">
                                        ...
                                        <el-input v-model="filters.contractNum" placeholder="合同号" auto-complete="off" clearable></el-input>
                                ...
                                <el-col :span="4">
                                    ...
                                    <el-form-item label="销售人员:">
                                        ...
                                        <el-input v-model="filters.sellman" placeholder="销售人员" auto-complete="off" clearable></el-input>
                                ...
                                <el-col :span="4">
                                    ...
                                    <el-form-item label="录单人:">
                                        ...
                                        <el-input v-model="filters.recordUser" placeholder="录单人" auto-complete="off" clearable></el-input>
                                ...
                                <el-col :span="2" :offset="5">
                                    ...
                                    <el-button icon="el-icon-search" size="normal" style="float: right; margin-right: -12px" type="primary" @click="search">查询
                        ...
                        <el-table element-loading-text="获取数据中..." :data="tableData" border show-overflow-tooltip="true" style="width: 100%;">
...
<template scope="scope">
    <div v-on:click="handleSign(scope.$index, scope.row)" style="font-weight: bold;" class="btn btn-link">
...
<template scope="scope">
    <div>
        ...
        {{formatDate(scope.row.createTime)}}</div>
</template>
                            </el-table-column>
...
<template scope="scope">
    <div>
        ...
        {{scope.row.updateTime != null ? formatDate(scope.row.updateTime) : ""}}</div>
</template>
                            </el-table-column>
...
<template scope="scope">
    <el-tooltip placement="top">
        ...
        <el-button v-show="userInfo.role.roleName !='销售员'" size="mini" type="success" icon="el-icon-check" @click="handleSign(scope.$index, scope.row)"></el-button>
    ...
    <el-tooltip placement="top">
        ...
        <el-button v-show="(userInfo.role.roleName.indexOf('销售') != -1 || userInfo.role.id == 1)" size="mini" type="primary" icon="el-icon-edit" @click="handleEdit(scope.$index, scope.row)"></el-button>
                                    ...
                                    <div class="panel panel-primary">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <el-col :span="6">
                                                ...
                                                >
<template scope="scope">
    <el-select v-model="item.orderDetail.electricMotorXy" clearable :disabled="(mode == 4 || mode == 5) && item.machineOrder.status != 0" :readonly="changeOrderContentDisable(item.machineOrder)" placeholder="请选择">
    
    
    
        <el-option v-for="item in xyMotorList" :key="item.text" :label="item.text" :value="item.text"></el-option>
                                            ...
                                            <el-col :span="6">
                                                ...
                                                >
<template scope="scope">
    <el-select v-model="item.orderDetail.electricTrim" clearable :disabled="(mode == 4 || mode == 5) && item.machineOrder.status != 0" :readonly="changeOrderContentDisable(item.machineOrder)" placeholder="请选择">
    
    
    
        <el-option v-for="item in trimList" :key="item.text" :label="item.text" :value="item.text"></el-option>
                                            ...
                                            <el-col :span="6">
                                                ...
                                                >
<template scope="scope">
    <el-select v-model="item.orderDetail.electricPower" clearable :disabled="(mode == 4 || mode == 5) && item.machineOrder.status != 0" :readonly="changeOrderContentDisable(item.machineOrder)" placeholder="请选择">
    
    
    
        <el-option v-for="item in electricPowerList" :key="item.text" :label="item.text" :value="item.text"></el-option>
    ...
    <!--
                                                ...
                                                >
<template scope="scope">
    <el-select v-model="item.orderDetail.colorChangeMode" clearable :disabled="(mode == 4 || mode == 5) && item.machineOrder.status != 0" :readonly="changeOrderContentDisable(item.machineOrder)" placeholder="请选择">
    
    
    
        <el-option v-for="item in colorChangeModeList" :key="item.text" :label="item.text" :value="item.text"></el-option>
                                            ...
                                            <el-col :span="6">
                                                ...
                                                >
<template scope="scope">
    <el-select v-model="item.orderDetail.electricOil" clearable :disabled="(mode == 4 || mode == 5) && item.machineOrder.status != 0" :readonly="changeOrderContentDisable(item.machineOrder)" placeholder="请选择">
    
    
    
        <el-option v-for="item in electricOilList" :key="item.text" :label="item.text" :value="item.text"></el-option>
                                    ...
                                    <div class="panel panel-primary">
                                        ...
                                        <div class="panel-body">
                                            <el-col :span="6">
                                                ...
                                                >
<template scope="scope">
    <el-select v-model="item.orderDetail.axleSplit" clearable :disabled="(mode == 4 || mode == 5) && item.machineOrder.status != 0" :readonly="changeOrderContentDisable(item.machineOrder)" placeholder="请选择">
    
    
    
        <el-option v-for="item in axleSplitList" :key="item.text" :label="item.text" :value="item.text"></el-option>
    ...
    <el-col :span="6">
        ...
        <el-form-item label="机针：" :label-width="formLabelWidth" :class="classWithDifferentValue(item, 'axleNeedle', true)">
    
    
    
            <el-input v-model="item.orderDetail.axleNeedle" style="width: 100%;" :disabled="(mode == 4 || mode == 5) && item.machineOrder.status != 0" :readonly="changeOrderContentDisable(item.machineOrder)"></el-input>
            ...
            <!--
                                            ...
                                            <el-col :span="6">
                                                ...
                                                >
<template scope="scope">
    <el-select v-model="item.orderDetail.axleNeedleType" clearable :disabled="(mode == 4 || mode == 5) && item.machineOrder.status != 0" :readonly="changeOrderContentDisable(item.machineOrder)" placeholder="请选择">
    
    
    
        <el-option v-for="item in axleNeedleTypeList" :key="item.text" :label="item.text" :value="item.text"></el-option>
                                    ...
                                    <div class="panel panel-primary">
                                        ...
                                        <div class="panel-body">
                                            <el-col :span="6">
                                                ...
                                                >
<template scope="scope">
    <el-select v-model="item.orderDetail.frameworkColor" clearable :disabled="(mode == 4 || mode == 5) && item.machineOrder.status != 0" :readonly="changeOrderContentDisable(item.machineOrder)" placeholder="请选择">
    
    
    
        <el-option v-for="item in frameworkColorList" :key="item.text" :label="item.text" :value="item.text"></el-option>
                                            ...
                                            <el-col :span="6">
                                                ...
                                                >
<template scope="scope">
    <el-select v-model="item.orderDetail.frameworkPlaten" clearable :disabled="(mode == 4 || mode == 5) && item.machineOrder.status != 0" :readonly="changeOrderContentDisable(item.machineOrder)" placeholder="请选择">
    
    
    
        <el-option v-for="item in frameworkPlatenList" :key="item.text" :label="item.text" :value="item.text"></el-option>
                                            ...
                                            <el-col :span="6">
                                                ...
                                                >
<template scope="scope">
    <el-select v-model="item.orderDetail.frameworkPlatenColor" clearable :disabled="(mode == 4 || mode == 5) && item.machineOrder.status != 0" :readonly="changeOrderContentDisable(item.machineOrder)" placeholder="请选择">
    
    
    
        <el-option v-for="item in frameworkPlatenColorList" :key="item.text" :label="item.text" :value="item.text"></el-option>
                                            ...
                                            <el-col :span="6">
                                                ...
                                                >
<template scope="scope">
    <el-select v-model="item.orderDetail.frameworkRing" clearable :disabled="(mode == 4 || mode == 5) && item.machineOrder.status != 0" :readonly="changeOrderContentDisable(item.machineOrder)" placeholder="请选择">
    
    
    
        <el-option v-for="item in frameworkRingList" :key="item.text" :label="item.text" :value="item.text"></el-option>
                                            ...
                                            <el-col :span="6">
                                                ...
                                                >
<template scope="scope">
    <el-select v-model="item.orderDetail.frameworkBracket" clearable :disabled="(mode == 4 || mode == 5) && item.machineOrder.status != 0" :readonly="changeOrderContentDisable(item.machineOrder)" placeholder="请选择">
    
    
    
        <el-option v-for="item in frameworkBracketList" :key="item.text" :label="item.text" :value="item.text"></el-option>
                                            ...
                                            <el-col :span="6">
                                                ...
                                                >
<template scope="scope">
    <el-select v-model="item.orderDetail.frameworkStop" clearable :disabled="(mode == 4 || mode == 5) && item.machineOrder.status != 0" :readonly="changeOrderContentDisable(item.machineOrder)" placeholder="请选择">
    
    
    
        <el-option v-for="item in frameworkStopList" :key="item.text" :label="item.text" :value="item.text"></el-option>
                                            ...
                                            <el-col :span="6">
                                                ...
                                                >
<template scope="scope">
    <el-select v-model="item.orderDetail.frameworkPoleHeight" clearable :disabled="(mode == 4 || mode == 5) && item.machineOrder.status != 0" :readonly="changeOrderContentDisable(item.machineOrder)" placeholder="请选择">
    
    
    
        <el-option v-for="item in frameworkPoleHeightList" :key="item.text" :label="item.text" :value="item.text"></el-option>
...
<template slot-scope="scope">
    <el-select v-model="scope.row.name" placeholder clearable :disabled="(mode == 4 || mode == 5) && item.machineOrder.status != 0" :readonly="changeOrderContentDisable(item.machineOrder)" style="width: 95%">
    
    
    
        <el-option v-for="item in machineEquipmentList" :key="item.text" :label="item.text" :value="item.text"></el-option>
...
<template slot-scope="scope">
    <el-input style="float: left" v-model="scope.row.type" :disabled="(mode == 4 || mode == 5) && item.machineOrder.status != 0" :readonly="changeOrderContentDisable(item.machineOrder)" controls-position="right">
...
<template slot-scope="scope">
    <el-input-number style="float: left" v-model="scope.row.number" :step="1" :disabled="(mode == 4 || mode == 5) && item.machineOrder.status != 0" :readonly="changeOrderContentDisable(item.machineOrder)" controls-position="right" :min="1">
                                                    ...
                                                    >
<template slot-scope="scope">
    <el-input v-model="scope.row.price" placeholder="单价" :disabled="(mode == 4 || mode == 5) && item.machineOrder.status != 0" :readonly="changeOrderContentDisable(item.machineOrder)" auto-complete="off">
...
<template slot-scope="scope">
    <el-button size="mini" type="danger" icon="el-icon-delete" :disabled="changeOrderContentDisable(item.machineOrder)" @click="handleDeleteEquipment(item.machineOrder.equipment, scope.$index)">
...
<template slot-scope="scope">
    <el-input :readonly="signDisable(item.orderSign.signContent,scope.row,item.machineOrder.status)" type="textarea" v-model="scope.row.comment" auto-complete="off">
...
<template scope="scope">
    <el-button type="primary" @click="onSubmitOrderSign(scope.row, item.orderSign)" icon="el-icon-check" size="small" :disabled="signDisable(item.orderSign.signContent,scope.row,item.machineOrder.status)">
    ...
    <el-button type="danger" @click="handleRejectOrderSign(scope.row, item.orderSign)" icon="el-icon-close" size="small" :disabled="signDisable(item.orderSign.signContent,scope.row,item.machineOrder.status)">驳回
...
<template>
    <el-table border ref="splitMachinesTable" :data="machinesOfOrder" tooltip-effect="dark" :empty-text="emptyTableText" style="width: 100%;margin-top: 10px" @selection-change="handleMachineSelectionChange">
        ...
        <el-table-column align="center" label="机器状态">
            ...
            <template slot-scope="scope">{{ filterMachineStatus(scope.row.status) }}
</template>
                        </el-table-column>
...
<template slot-scope="scope">
    <span style="font-size: 14px; font-weight: bold">{{scope.row.roleId | filterRole}}</span>
                    ...
                    <el-table-column align="center" width="150" label="签核人">
<template slot-scope="scope">
    <el-input :readonly="signDisable(signItem.signContent,scope.row,item.machineOrder.status)" v-model="scope.row.user" auto-complete="off">
...
<template slot-scope="scope">
    <span>{{scope.row.date != null && scope.row.date != "" ? scope.row.date : "未提交" }}</span>
                    ...
                    <el-table-column align="center" label="意见">
<template slot-scope="scope">
    <el-input :readonly="signDisable(signItem.signContent,scope.row,item.machineOrder.status)" type="textarea" v-model="scope.row.comment" auto-complete="off">
...
<template scope="scope">
    ...
    <div v-else>
        ...
        <el-button style="font-size: 14px; font-weight: bold" type="info" round disabled size="mini">{{scope.row.number}}</el-button>
...
<template slot-scope="scope">
    <span>{{scope.row.date != null && scope.row.date != "" ? formatDate(scope.row.date) : "未提交" }}</span>
                                        ...
                                        <el-table-column align="center" label="意见" >
<template slot-scope="scope">
    <el-input type="textarea" clearable :disabled="lxdSignDisable(scope.row)" v-model="scope.row.comment" auto-complete="off">
...
<template scope="scope">
    <el-tooltip placement="top" content="同意" v-show="isRowHasPermissionToShow(scope.row)">
        ...
        <el-button :disabled="lxdSignDisable(scope.row)" type="success" icon="el-icon-check" size="mini" @click="handleSubmitLxdSign(scope.row)"></el-button>
    ...
    <el-tooltip placement="top" content="驳回" v-show="isRowHasPermissionToShow(scope.row)">
        ...
        <el-button :disabled="lxdSignDisable(scope.row)" type="danger" icon="el-icon-close" size="mini" @click="handleRejectLxdSign(scope.row)"></el-button>
...
export default {
    ...
    methods: {
        ...
        clickTab(clickItem) {
            _this.currentSelectOrder = clickItem;
        },
        ...
        addTab(targetName) {
            ...
            let currentItem=copyObjectByJSON(_this.requisitionForms[_this.tabIndex - 2]);
            newItem.machineOrder = Object.assign({},currentItem.machineOrder)
            newItem.orderDetail = Object.assign({},currentItem.orderDetail)
            newItem.orderSign = copyObjectByJSON(currentItem.orderSign) != null ? copyObjectByJSON(currentItem.orderSign) : {};
            ...
            newItem.machineOrder.sellman =_this.contractForm.sellman;
        ...
        onConfirmPasteOrder() {
            ...
            for (let i = 0; i < _this.requisitionForms.length; i++) {
                if (_this.requisitionForms[i].title == _this.currentSelectOrder.title) {
                    index = i;
                    break;
                }
            }
            _this.currentCopyItem = copyObjectByJSON(
                _this.currentCopyItem
            );
            Object.keys(_this.requisitionForms[index].orderDetail).forEach(key=>{_this.requisitionForms[index].orderDetail[key]=_this.currentCopyItem.orderDetail[key]})
            Object.assign(_this.requisitionForms[index].orderDetail,_this.currentCopyItem.orderDetail)

            _this.requisitionForms[index].machineOrder.brand =
                _this.currentCopyItem.machineOrder.brand;

            _this.requisitionForms[index].machineOrder.needleNum =
                _this.currentCopyItem.machineOrder.needleNum;
            _this.requisitionForms[index].machineOrder.headNum =
                _this.currentCopyItem.machineOrder.headNum;
            _this.requisitionForms[index].machineOrder.headDistance =
                _this.currentCopyItem.machineOrder.headDistance;
            _this.requisitionForms[index].machineOrder.xDistance =
                _this.currentCopyItem.machineOrder.xDistance;
            _this.requisitionForms[index].machineOrder.yDistance =
                _this.currentCopyItem.machineOrder.yDistance;
            _this.requisitionForms[index].machineOrder.packageMethod =
                _this.currentCopyItem.machineOrder.packageMethod;
            _this.requisitionForms[index].machineOrder.maintainType =
                _this.currentCopyItem.machineOrder.maintainType;
            _this.requisitionForms[index].machineOrder.mark =
                _this.currentCopyItem.machineOrder.mark;
            _this.requisitionForms[index].machineOrder.equipment =
                _this.currentCopyItem.machineOrder.equipment;
            _this.requisitionForms[index].machineOrder.machinePrice =
                _this.currentCopyItem.machineOrder.machinePrice;
            _this.requisitionForms[index].machineOrder.packageMark =
        ...
        handleAdd() {
            ...
            this.tabIndex = 1;
            _this.editableTabsValue=_this.requisitionForms[0].name;
            _this.contractSignForms[0].contractSignData =
                _this.normalContractSignArray;
        },
        ...
        onAdd() {
            ...
            if (!_this.isError) {
                for (
                    let i = 0; i < _this.requisitionForms.length && !_this.isError; i++
                ) {
        ...
        classWithDifferentValue(item, type, isDetail) {
            let comparedItem = '';
            if (!isUndefined(item.machineOrder.originalOrderId) &&
        ...
        filterIsSigning() {
            let result = false;
            for (
                let i = 0; i < _this.orderStatusForFilterList.length && !result; i++
            ) {
    ...
    computed: {
        ...
        isShowWorkContactForm: function() { //test为计算属性，调用时和调用属性一样调用test即可
            ...
            if (res) { /// 这是一个workAround, 因为工作联系单里本来是不需要hopeDate
