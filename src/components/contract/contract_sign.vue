        ...
        <el-row>
          <el-col>
            ...
            >
              ...
              <el-table-column align="center" min-width="125" prop="customerName" label="客户"></el-table-column>
                  ...
                  <div class="panel panel-primary">
                    ...
                    <div class="panel-body" v-if="isFinanceVisible()">
                      <table border="1" width="100%">
                        ...
                        <tr>
                          <td colspan="2" style="font-weight: bold; font-size: 14px">居间费用 / 台</td>
                        ...
                        <tr>
                          <td colspan="2" style="font-weight: bold; font-size: 14px">优惠金额 / 台</td>
